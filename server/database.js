...
async function initDb() {
    ...
    await db.exec(`
        CREATE TABLE IF NOT EXISTS books (
            ...
            cover_title      VARCHAR(512) DEFAULT 'Our Timeless Journey',
            cover_subtitle   VARCHAR(512) DEFAULT 'A collection of memories, frozen in time.',
            instruction_text VARCHAR(512) DEFAULT 'Tap to open',
            end_title        VARCHAR(512) DEFAULT 'THE END',
